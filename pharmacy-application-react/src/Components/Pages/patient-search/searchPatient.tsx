...
const SearchPatient = () => {
  ...
  const colDefs: any[] = [
    ...
    { headerName: "Amount Paid", field: "amountPaid", width: 140 },
    { headerName: "Order Number", field: "orderNumber", width: 140 },
    { headerName: "Sequence Number", field: "sequenceNumber", width: 140 },
    { headerName: "Bill Number", field: "billNumber", width: 140 },
      ...
      <div className="row">
        <div className="col">
          <TextField
            ...
            id="order-number"
            name="orderNumber"
            value={patientSearch.orderNumber}
            ...
            onChange={(event) => {
              onChangePatient("orderNumber", event.target.value);
            }}
          />
        </div>
